EXEC msdb.dbo.sp_delete_database_backuphistory @database_name = N'HCDB_2_TEST'
GO
USE [master]
GO
ALTER DATABASE [HCDB_2_TEST] SET  SINGLE_USER WITH ROLLBACK IMMEDIATE
GO
USE [master]
GO
/****** Object:  Database [HCDB_2_TEST]    Script Date: 2015/3/13 11:00:40 ******/
DROP DATABASE [HCDB_2_TEST]
GO


CREATE DATABASE HCDB_2_TEST
GO
...
INSERT INTO HCDB_2_TEST.dbo.T_PRIVILEGE (name,parent_id,parent_ids,permission,api,href,icon,notes) VALUES (
'root',0,'0,','','','','','');
INSERT INTO HCDB_2_TEST.dbo.T_PRIVILEGE (name,parent_id,parent_ids,permission,api,href,icon,notes) VALUES (
'用户',1,'0,1','','','','','');
INSERT INTO HCDB_2_TEST.dbo.T_PRIVILEGE (name,parent_id,parent_ids,permission,api,href,icon,notes) VALUES (
...
INSERT INTO HCDB_2_TEST.dbo.T_CARE_ITEM (gero_id,name,icon,level,period,frequency,start_time,end_time,notes,del_flag) VALUES (
...
INSERT INTO HCDB_2_TEST.dbo.T_ROLE_PRIVILEGES (role_id,privilege_id) VALUES (
1,1);
INSERT INTO HCDB_2_TEST.dbo.T_ROLE_PRIVILEGES (role_id,privilege_id) VALUES (
1,2);
INSERT INTO HCDB_2_TEST.dbo.T_ROLE_PRIVILEGES (role_id,privilege_id) VALUES (
