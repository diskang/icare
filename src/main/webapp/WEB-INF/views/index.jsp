...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="static/css/host_demo.css" />
        <link rel="stylesheet" type="text/css" href="static/css/host_style.css" />
    ...
    <body onLoad="init()">
        <div class="container">
			<section id="dg-container" class="dg-container">
				<div class="dg-wrapper" id="geros-list">
				</div>
                <nav>    
